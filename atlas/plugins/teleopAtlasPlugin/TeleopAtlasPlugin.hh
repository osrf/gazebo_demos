...
#ifndef _GAZEBO_TELEOP_ATLAS_PLUGIN_HH_
#define _GAZEBO_TELEOP_ATLAS_PLUGIN_HH_
...
namespace gazebo
{
  class TeleopAtlasPlugin : public ModelPlugin
  {
    /// \brief Constructor
    public: TeleopAtlasPlugin();

    /// \brief Destructor
    public: virtual ~TeleopAtlasPlugin();
